...
RETAILERS: list[RetailerDef] = [
    ...
    RetailerDef("albertsons",   ["Albertsons", "Albertsons Market"]),
    RetailerDef("safeway",      ["Safeway"]),
    RetailerDef("pavilions",    ["Pavilions"]),
    RetailerDef("publix",       ["Publix", "Publix Super Market"]),
    RetailerDef("northgate",    ["Northgate Market", "Northgate González Market"]),
    RetailerDef("gelsons",      ["Gelson's"]),
    RetailerDef("kroger",       ["Kroger", "Kroger Marketplace"]),
    RetailerDef("superking",    ["Super King Market", "Super King Markets"]),
    RetailerDef("beverlyhills", ["Beverly Hills Market"]),
    RetailerDef("lacarreta",    ["La Carreta Supermarket", "La Carreta"]),
    RetailerDef("elsuper",      ["El Super", "El Super Market"]),
    RetailerDef("vallarta",     ["Vallarta Supermarkets", "Vallarta"]),
    RetailerDef("bristolfarms", ["Bristol Farms"]),
    RetailerDef("cardenas",     ["Cardenas Markets", "Cardenas Market"]),
    RetailerDef("erewhon",      ["Erewhon"]),
    RetailerDef("hmart",        ["H Mart", "H-Mart", "Hmart"]),
    RetailerDef("99ranch",      ["99 Ranch Market", "Ranch 99"]),
